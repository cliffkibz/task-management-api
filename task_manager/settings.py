...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-u@9-jt48g5#2@tt8)%ogcvb-yc#ni*kk11oau$a0^72im72yxc')
...
ALLOWED_HOSTS = [h for h in [host.strip() for host in allowed_hosts.split(',')] if h] if allowed_hosts else []
